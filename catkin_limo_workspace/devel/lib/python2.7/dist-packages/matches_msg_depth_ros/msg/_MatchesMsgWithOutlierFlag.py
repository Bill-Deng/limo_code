...
"""autogenerated by genpy from matches_msg_depth_ros/MatchesMsgWithOutlierFlag.msg. Do not edit."""
import sys
...
class MatchesMsgWithOutlierFlag(genpy.Message):
  _md5sum = "199349e17772d3a58b66b7559e03c0fb"
  _type = "matches_msg_depth_ros/MatchesMsgWithOutlierFlag"
...
"""
  ...
  _slot_types = ['std_msgs/Header','matches_msg_depth_ros/TrackletWithOutlierFlag[]','time[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MatchesMsgWithOutlierFlag, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = matches_msg_depth_ros.msg.TrackletWithOutlierFlag()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.feature_points = []
        ...
        val1.is_outlier = bool(val1.is_outlier)
