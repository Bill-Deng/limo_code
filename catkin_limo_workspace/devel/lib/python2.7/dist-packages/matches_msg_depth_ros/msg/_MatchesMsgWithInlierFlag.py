...
"""autogenerated by genpy from matches_msg_depth_ros/MatchesMsgWithInlierFlag.msg. Do not edit."""
import sys
...
class MatchesMsgWithInlierFlag(genpy.Message):
  _md5sum = "dfa650e1428e434367af8c618c20dd07"
  _type = "matches_msg_depth_ros/MatchesMsgWithInlierFlag"
...
"""
  ...
  _slot_types = ['std_msgs/Header','matches_msg_depth_ros/TrackletWithInlierFlag[]','time[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MatchesMsgWithInlierFlag, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = matches_msg_depth_ros.msg.TrackletWithInlierFlag()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.feature_points = []
        ...
        val1.is_inlier = bool(val1.is_inlier)
