...
subscriber_description = [{'topic_param': 'subscriber_topic', 'description': 'subscriber', 'watch': [], 'header': ['sensor_msgs/Image.h'], 'min_frequency_param': None, 'import': ['sensor_msgs.msg'], 'name': 'subscriber', 'queue_size_param': 'subscriber_queue_size', 'no_delay': True, 'configurable': True, 'max_delay_param': None, 'diagnosed': False, 'scope': 'private', 'type': 'sensor_msgs::Image'}]
publisher_description = [{'topic_param': 'publisher_topic', 'description': 'publisher', 'header': ['sensor_msgs/Image.h'], 'min_frequency_param': None, 'scope': 'private', 'name': 'publisher', 'queue_size_param': 'publisher_queue_size', 'configurable': True, 'max_delay_param': None, 'diagnosed': False, 'import': ['sensor_msgs.msg'], 'type': 'sensor_msgs::Image'}]
