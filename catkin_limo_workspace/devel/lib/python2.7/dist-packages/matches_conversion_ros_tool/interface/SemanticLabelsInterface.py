...
inf = float('inf')
param_description = [{'constant': False, 'description': 'Sets the verbosity for this node', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': 'verbosity', 'name': 'verbosity', 'min': None, 'default': 'info', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_debug', 'min': None, 'default': 'debug', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_info', 'min': None, 'default': 'info', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_warning', 'min': None, 'default': 'warning', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_error', 'min': None, 'default': 'error', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_fatal', 'min': None, 'default': 'fatal', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'width of roi to count labels', 'pytype': 'int', 'max': 50, 'is_vector': False, 'edit_method': '""', 'name': 'roi_width', 'min': 0, 'default': 5, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'int'}, {'constant': False, 'description': 'height of roi to count labels', 'pytype': 'int', 'max': 50, 'is_vector': False, 'edit_method': '""', 'name': 'roi_height', 'min': 0, 'default': 5, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'int'}, {'constant': False, 'description': 'Topic for subscriber with matches to assign label', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'subscriber_matches_topic', 'min': None, 'default': 'in_topic_matches', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Queue size for subscriber with matches to assign label', 'pytype': 'int', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'subscriber_matches_queue_size', 'min': 0, 'default': 5, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'int'}, {'constant': False, 'description': 'Topic for subscriber with matches to assign label', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'subscriber_labels_topic', 'min': None, 'default': 'in_topic_semantic_labels', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Queue size for subscriber with matches to assign label', 'pytype': 'int', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'subscriber_labels_queue_size', 'min': 0, 'default': 5, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'int'}, {'constant': False, 'description': 'Topic for publisher with matches to assign label', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'matches_publisher_topic', 'min': None, 'default': 'out_topic', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Queue size for publisher with matches to assign label', 'pytype': 'int', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'matches_publisher_queue_size', 'min': 0, 'default': 5, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'int'}]
subscriber_description = [{'topic_param': 'subscriber_matches_topic', 'description': 'subscriber with matches to assign label', 'watch': [], 'header': ['matches_msg_depth_ros/MatchesMsgWithOutlierFlag.h'], 'min_frequency_param': None, 'import': ['matches_msg_depth_ros.msg'], 'name': 'subscriber_matches', 'queue_size_param': 'subscriber_matches_queue_size', 'no_delay': True, 'configurable': True, 'max_delay_param': None, 'diagnosed': False, 'scope': 'private', 'type': 'matches_msg_depth_ros::MatchesMsgWithOutlierFlag'}, {'topic_param': 'subscriber_labels_topic', 'description': 'subscriber with matches to assign label', 'watch': [], 'header': ['sensor_msgs/Image.h'], 'min_frequency_param': None, 'import': ['sensor_msgs.msg'], 'name': 'subscriber_labels', 'queue_size_param': 'subscriber_labels_queue_size', 'no_delay': True, 'configurable': True, 'max_delay_param': None, 'diagnosed': False, 'scope': 'private', 'type': 'sensor_msgs::Image'}]
publisher_description = [{'topic_param': 'matches_publisher_topic', 'description': 'publisher with matches to assign label', 'header': ['matches_msg_depth_ros/MatchesMsgWithOutlierFlag.h'], 'min_frequency_param': None, 'scope': 'private', 'name': 'matches_publisher', 'queue_size_param': 'matches_publisher_queue_size', 'configurable': True, 'max_delay_param': None, 'diagnosed': False, 'import': ['matches_msg_depth_ros.msg'], 'type': 'matches_msg_depth_ros::MatchesMsgWithOutlierFlag'}]
...
class SemanticLabelsInterface(dict):
    def __init__(self):
