...
inf = float('inf')
param_description = [{'constant': False, 'description': 'Sets the verbosity for this node', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': 'verbosity', 'name': 'verbosity', 'min': None, 'default': 'info', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_debug', 'min': None, 'default': 'debug', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_info', 'min': None, 'default': 'info', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_warning', 'min': None, 'default': 'warning', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_error', 'min': None, 'default': 'error', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_fatal', 'min': None, 'default': 'fatal', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Topic for subscriber for tracklets with depth', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'subscriber_depth_topic', 'min': None, 'default': 'in_topic_depth', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Queue size for subscriber for tracklets with depth', 'pytype': 'int', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'subscriber_depth_queue_size', 'min': 0, 'default': 5, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'int'}, {'constant': False, 'description': 'Topic for subscriber for tracklets woth outliers, f.e. from momo', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'subscriber_outliers_topic', 'min': None, 'default': 'in_topic_outliers', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Queue size for subscriber for tracklets woth outliers, f.e. from momo', 'pytype': 'int', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'subscriber_outliers_queue_size', 'min': 0, 'default': 5, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'int'}, {'constant': False, 'description': 'Topic for publisher for tracklets with depth and outlier flags', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'publisher_depth_outliers_topic', 'min': None, 'default': 'out_topic', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Queue size for publisher for tracklets with depth and outlier flags', 'pytype': 'int', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'publisher_depth_outliers_queue_size', 'min': 0, 'default': 5, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'int'}]
subscriber_description = [{'topic_param': 'subscriber_depth_topic', 'description': 'subscriber for tracklets with depth', 'watch': [], 'header': ['matches_msg_depth_ros/MatchesMsg.h'], 'min_frequency_param': None, 'import': ['matches_msg_depth_ros.msg'], 'name': 'subscriber_depth', 'queue_size_param': 'subscriber_depth_queue_size', 'no_delay': True, 'configurable': True, 'max_delay_param': None, 'diagnosed': False, 'scope': 'private', 'type': 'matches_msg_depth_ros::MatchesMsg'}, {'topic_param': 'subscriber_outliers_topic', 'description': 'subscriber for tracklets woth outliers, f.e. from momo', 'watch': [], 'header': ['matches_msg_ros/MatchesMsgWithOutlierFlag.h'], 'min_frequency_param': None, 'import': ['matches_msg_ros.msg'], 'name': 'subscriber_outliers', 'queue_size_param': 'subscriber_outliers_queue_size', 'no_delay': True, 'configurable': True, 'max_delay_param': None, 'diagnosed': False, 'scope': 'private', 'type': 'matches_msg_ros::MatchesMsgWithOutlierFlag'}]
publisher_description = [{'topic_param': 'publisher_depth_outliers_topic', 'description': 'publisher for tracklets with depth and outlier flags', 'header': ['matches_msg_depth_ros/MatchesMsgWithOutlierFlag.h'], 'min_frequency_param': None, 'scope': 'private', 'name': 'publisher_depth_outliers', 'queue_size_param': 'publisher_depth_outliers_queue_size', 'configurable': True, 'max_delay_param': None, 'diagnosed': False, 'import': ['matches_msg_depth_ros.msg'], 'type': 'matches_msg_depth_ros::MatchesMsgWithOutlierFlag'}]
...
class MarkDepthOutlierInterface(dict):
    def __init__(self):
