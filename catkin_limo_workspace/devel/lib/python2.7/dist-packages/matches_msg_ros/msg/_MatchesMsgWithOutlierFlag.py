...
"""autogenerated by genpy from matches_msg_ros/MatchesMsgWithOutlierFlag.msg. Do not edit."""
import sys
...
class MatchesMsgWithOutlierFlag(genpy.Message):
  _md5sum = "1ebd216679e7bafc403d47a2f741b116"
  _type = "matches_msg_ros/MatchesMsgWithOutlierFlag"
...
"""
  ...
  _slot_types = ['std_msgs/Header','matches_msg_ros/TrackletWithOutlierFlag[]','time[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = matches_msg_ros.msg.TrackletWithOutlierFlag()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.feature_points = []
