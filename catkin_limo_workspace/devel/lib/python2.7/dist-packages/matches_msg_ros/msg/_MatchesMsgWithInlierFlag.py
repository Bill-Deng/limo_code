...
"""autogenerated by genpy from matches_msg_ros/MatchesMsgWithInlierFlag.msg. Do not edit."""
import sys
...
class MatchesMsgWithInlierFlag(genpy.Message):
  _md5sum = "a3539017197453baece313b9f907ec7a"
  _type = "matches_msg_ros/MatchesMsgWithInlierFlag"
...
"""
  ...
  _slot_types = ['std_msgs/Header','matches_msg_ros/TrackletWithInlierFlag[]','time[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = matches_msg_ros.msg.TrackletWithInlierFlag()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.feature_points = []
