...
(cl:defclass <MatchesMsg> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (tracks
    :reader tracks
    :initarg :tracks
    :type (cl:vector matches_msg_ros-msg:Tracklet)
   :initform (cl:make-array 0 :element-type 'matches_msg_ros-msg:Tracklet :initial-element (cl:make-instance 'matches_msg_ros-msg:Tracklet)))
   (stamps
    :reader stamps
    :initarg :stamps
...
(cl:defmethod cl:initialize-instance :after ((m <MatchesMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MatchesMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name matches_msg_ros-msg:<MatchesMsg> is deprecated: use matches_msg_ros-msg:MatchesMsg instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MatchesMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'tracks)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'matches_msg_ros-msg:Tracklet))
