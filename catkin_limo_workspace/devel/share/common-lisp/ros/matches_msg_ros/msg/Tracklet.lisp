...
(cl:defmethod cl:initialize-instance :after ((m <Tracklet>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Tracklet)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name matches_msg_ros-msg:<Tracklet> is deprecated: use matches_msg_ros-msg:Tracklet instead.")))
