...
(cl:defclass <MatchesMsgWithInlierFlag> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (tracks
    :reader tracks
    :initarg :tracks
    :type (cl:vector matches_msg_ros-msg:TrackletWithInlierFlag)
   :initform (cl:make-array 0 :element-type 'matches_msg_ros-msg:TrackletWithInlierFlag :initial-element (cl:make-instance 'matches_msg_ros-msg:TrackletWithInlierFlag)))
   (stamps
    :reader stamps
    :initarg :stamps
...
(cl:defmethod cl:initialize-instance :after ((m <MatchesMsgWithInlierFlag>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MatchesMsgWithInlierFlag)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name matches_msg_ros-msg:<MatchesMsgWithInlierFlag> is deprecated: use matches_msg_ros-msg:MatchesMsgWithInlierFlag instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <MatchesMsgWithInlierFlag>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader matches_msg_ros-msg:header-val is deprecated.  Use matches_msg_ros-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'tracks-val :lambda-list '(m))
(cl:defmethod tracks-val ((m <MatchesMsgWithInlierFlag>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader matches_msg_ros-msg:tracks-val is deprecated.  Use matches_msg_ros-msg:tracks instead.")
  (tracks m))

(cl:ensure-generic-function 'stamps-val :lambda-list '(m))
(cl:defmethod stamps-val ((m <MatchesMsgWithInlierFlag>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader matches_msg_ros-msg:stamps-val is deprecated.  Use matches_msg_ros-msg:stamps instead.")
  (stamps m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MatchesMsgWithInlierFlag>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'tracks)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'matches_msg_ros-msg:TrackletWithInlierFlag))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MatchesMsgWithInlierFlag>)))
  ...
  "matches_msg_ros/MatchesMsgWithInlierFlag")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MatchesMsgWithInlierFlag)))
  "Returns string type for a message object of type 'MatchesMsgWithInlierFlag"
  "matches_msg_ros/MatchesMsgWithInlierFlag")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MatchesMsgWithInlierFlag>)))
  ...
  "a3539017197453baece313b9f907ec7a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MatchesMsgWithInlierFlag)))
  "Returns md5sum for a message object of type 'MatchesMsgWithInlierFlag"
  "a3539017197453baece313b9f907ec7a")
