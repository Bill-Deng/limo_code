...
(cl:defclass <MatchesMsgWithOutlierFlag> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (tracks
    :reader tracks
    :initarg :tracks
    :type (cl:vector matches_msg_ros-msg:TrackletWithOutlierFlag)
   :initform (cl:make-array 0 :element-type 'matches_msg_ros-msg:TrackletWithOutlierFlag :initial-element (cl:make-instance 'matches_msg_ros-msg:TrackletWithOutlierFlag)))
   (stamps
    :reader stamps
    :initarg :stamps
...
(cl:defmethod cl:initialize-instance :after ((m <MatchesMsgWithOutlierFlag>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MatchesMsgWithOutlierFlag)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name matches_msg_ros-msg:<MatchesMsgWithOutlierFlag> is deprecated: use matches_msg_ros-msg:MatchesMsgWithOutlierFlag instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MatchesMsgWithOutlierFlag>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'tracks)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'matches_msg_ros-msg:TrackletWithOutlierFlag))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MatchesMsgWithOutlierFlag>)))
  ...
  "matches_msg_ros/MatchesMsgWithOutlierFlag")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MatchesMsgWithOutlierFlag)))
  "Returns string type for a message object of type 'MatchesMsgWithOutlierFlag"
  "matches_msg_ros/MatchesMsgWithOutlierFlag")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MatchesMsgWithOutlierFlag>)))
  ...
  "1ebd216679e7bafc403d47a2f741b116")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MatchesMsgWithOutlierFlag)))
  "Returns md5sum for a message object of type 'MatchesMsgWithOutlierFlag"
  "1ebd216679e7bafc403d47a2f741b116")
