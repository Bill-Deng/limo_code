...
(cl:defmethod cl:initialize-instance :after ((m <FeaturePoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FeaturePoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name matches_msg_ros-msg:<FeaturePoint> is deprecated: use matches_msg_ros-msg:FeaturePoint instead.")))

(cl:ensure-generic-function 'u-val :lambda-list '(m))
(cl:defmethod u-val ((m <FeaturePoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader matches_msg_ros-msg:u-val is deprecated.  Use matches_msg_ros-msg:u instead.")
  (u m))

(cl:ensure-generic-function 'v-val :lambda-list '(m))
(cl:defmethod v-val ((m <FeaturePoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader matches_msg_ros-msg:v-val is deprecated.  Use matches_msg_ros-msg:v instead.")
  (v m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FeaturePoint>)))
  ...
  (cl:format cl:nil "# no header because shall not be send alone~%# Data field Matches (as tracklets, el.first == u el.second == v)~%float32 u~%float32 v~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FeaturePoint)))
  "Returns full string definition for message of type 'FeaturePoint"
  (cl:format cl:nil "# no header because shall not be send alone~%# Data field Matches (as tracklets, el.first == u el.second == v)~%float32 u~%float32 v~%~%~%"))
