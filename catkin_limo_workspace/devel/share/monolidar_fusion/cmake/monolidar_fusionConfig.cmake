...
if(monolidar_fusion_CONFIG_INCLUDED)
  return()
endif()
set(monolidar_fusion_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(monolidar_fusion_SOURCE_PREFIX /home/dlx/catkin_limo_workspace/src/mono_lidar_depth/monolidar_fusion)
  set(monolidar_fusion_DEVEL_PREFIX /home/dlx/catkin_limo_workspace/devel)
  set(monolidar_fusion_INSTALL_PREFIX "")
  set(monolidar_fusion_PREFIX ${monolidar_fusion_DEVEL_PREFIX})
else()
  set(monolidar_fusion_SOURCE_PREFIX "")
  set(monolidar_fusion_DEVEL_PREFIX "")
  set(monolidar_fusion_INSTALL_PREFIX /home/dlx/catkin_limo_workspace/install)
  set(monolidar_fusion_PREFIX ${monolidar_fusion_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'monolidar_fusion' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND monolidar_fusion_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dlx/catkin_limo_workspace/devel/lib;/home/dlx/catkin_limo_workspace/devel/lib;/home/dlx/catkin_ws/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(monolidar_fusion_LIBRARY_DIRS ${lib_path})
      list(APPEND monolidar_fusion_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'monolidar_fusion'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND monolidar_fusion_LIBRARIES ${lib})
    endif()
  endif()
...
set(monolidar_fusion_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${monolidar_fusion_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 monolidar_fusion_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${monolidar_fusion_dep}_FOUND)
      find_package(${monolidar_fusion_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${monolidar_fusion_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(monolidar_fusion_INCLUDE_DIRS ${${monolidar_fusion_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(monolidar_fusion_LIBRARIES ${monolidar_fusion_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${monolidar_fusion_dep}_LIBRARIES})
  _list_append_deduplicate(monolidar_fusion_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(monolidar_fusion_LIBRARIES ${monolidar_fusion_LIBRARIES})

  _list_append_unique(monolidar_fusion_LIBRARY_DIRS ${${monolidar_fusion_dep}_LIBRARY_DIRS})
  list(APPEND monolidar_fusion_EXPORTED_TARGETS ${${monolidar_fusion_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${monolidar_fusion_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
