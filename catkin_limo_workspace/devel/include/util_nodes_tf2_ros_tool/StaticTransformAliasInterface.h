...
#include <util_nodes_tf2_ros_tool/StaticTransformAliasConfig.h>
#pragma GCC diagnostic pop
#else
struct StaticTransformAliasConfig{};
#endif
...
struct StaticTransformAliasInterface {

  using Config = StaticTransformAliasConfig;
#ifdef MESSAGE_FILTERS_FOUND
  template<typename T>
  ...
  StaticTransformAliasInterface(const ros::NodeHandle& private_node_handle)
  : globalNamespace_{"/"},
  ...
  void fromParamServer(){
    ...
    success &= rosinterface_handler::getParam(privateNamespace_ + "diag_pub_msg_name", diag_pub_msg_name, std::string{"out_topic_diagnosed"});
    success &= rosinterface_handler::getParam(privateNamespace_ + "diagnostic_updater_name", diagnostic_updater_name, std::string{"StaticTransformAliasUpdater"});
    success &= rosinterface_handler::getParam(privateNamespace_ + "diagnostic_updater_hardware_id", diagnostic_updater_hardware_id, std::string{"StaticTransformAlias"});
    ...
    success &= rosinterface_handler::getParam(privateNamespace_ + "from_source_frame_id", from_source_frame_id, std::string{"from/source"});
    success &= rosinterface_handler::getParam(privateNamespace_ + "to_source_frame_id", to_source_frame_id, std::string{"to/source"});
    success &= rosinterface_handler::getParam(privateNamespace_ + "from_target_frame_id", from_target_frame_id, std::string{"from/target"});
    success &= rosinterface_handler::getParam(privateNamespace_ + "to_target_frame_id", to_target_frame_id, std::string{"to/target"});
    success &= rosinterface_handler::getParam(privateNamespace_ + "timeout", timeout, double{10.});



    rosinterface_handler::testMin<int>(privateNamespace_ + "msg_queue_size", msg_queue_size, 1);
    rosinterface_handler::testMin<double>(privateNamespace_ + "timeout", timeout, 0.5);
    rosinterface_handler::testMax<double>(privateNamespace_ + "timeout", timeout, 60);
    if(!success){
  ...
  void toParamServer(){
    ...
    rosinterface_handler::setParam(privateNamespace_ + "diag_pub_msg_name",diag_pub_msg_name);
    ...
    rosinterface_handler::setParam(privateNamespace_ + "from_source_frame_id",from_source_frame_id);
    rosinterface_handler::setParam(privateNamespace_ + "to_source_frame_id",to_source_frame_id);
    rosinterface_handler::setParam(privateNamespace_ + "from_target_frame_id",from_target_frame_id);
    rosinterface_handler::setParam(privateNamespace_ + "to_target_frame_id",to_target_frame_id);
    rosinterface_handler::setParam(privateNamespace_ + "timeout",timeout);
  }
  ...
  void fromConfig(const Config& config, const uint32_t level = 0){
    ...
    from_source_frame_id = config.from_source_frame_id;
    to_source_frame_id = config.to_source_frame_id;
    from_target_frame_id = config.from_target_frame_id;
    to_target_frame_id = config.to_target_frame_id;
  ...
  friend std::ostream& operator<<(std::ostream& os, const StaticTransformAliasInterface& p)
  {
    os << "[" << p.nodeName_ << "]\nNode " << p.nodeName_ << " has the following parameters:\n"
      ...
      << "	" << p.privateNamespace_ << "diag_pub_msg_name:" << p.diag_pub_msg_name << "\n"
      ...
      << "	" << p.privateNamespace_ << "from_source_frame_id:" << p.from_source_frame_id << "\n"
      << "	" << p.privateNamespace_ << "to_source_frame_id:" << p.to_source_frame_id << "\n"
      << "	" << p.privateNamespace_ << "from_target_frame_id:" << p.from_target_frame_id << "\n"
      << "	" << p.privateNamespace_ << "to_target_frame_id:" << p.to_target_frame_id << "\n"
      << "	" << p.privateNamespace_ << "timeout:" << p.timeout << "\n"
;
    return os;
  }
...
public:
  ...
  std::string diag_pub_msg_name; /*!< Topicname for diagnostic publisher */
  ...
  std::string from_source_frame_id; /*!< tf2 frame id of the source frame from which to read */
  std::string to_source_frame_id; /*!< tf2 frame id of the source frame to which we map */
  std::string from_target_frame_id; /*!< tf2 frame id of the target frame from which to read */
  std::string to_target_frame_id; /*!< tf2 frame id of the target frame to which we map */
  double timeout; /*!< time in secondsd before failing */
